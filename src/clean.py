...
def retrieve(title):
    ...
    PATH = f"{root_path}/data/{title}.txt"
    PATH_TEMP = f"{root_path}/data/{title}_temp.txt"
    PATH_OLD = f"{root_path}/data/{title}_old.txt"
    words = []
...
if __name__ == "__main__":
    categories = ["meat", "plants", "sports", "travel", "fruits", "animals"]
